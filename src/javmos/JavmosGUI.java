...
public final class JavmosGUI {
    ...
    private final JFrame frame = new JFrame("Javmos v1.0 student ver");
    private final JPanel mainPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0)); //Layout
    private final JavmosPanel javmosPanel = new JavmosPanel(this); //JM
    private final JPanel controlPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0)); //Layout
    private final JPanel domainStepPanel = new JPanel(new GridLayout(2, 1)); //Layout
    private final JPanel rangeStepPanel = new JPanel(new GridLayout(2, 1)); //Layout
    ...
    private JPanel createJavmosPanel() { //JavmosPanel is the cartesian grid, not the buttons.
        // Configure the Javmos panel
        javmosPanel.setPreferredSize(new Dimension(PLANE_PANEL_WIDTH, PLANE_PANEL_HEIGHT)); //JMM
        javmosPanel.addMouseListener(new PointClickListener(this)); //JMM
    ...
    private JPanel createControlPanel() {
        ...
        configureComponent(equationField, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, drawListener, "", inputBackgroundColor, Color.GREEN);
        ...
        configureComponent(secondDerivativeLabel, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, null, "", displayBackgroundColor, Color.decode("#00bbff"));
        ...
        controlPanel.add(domainStepPanel); //Panel
        controlPanel.add(maxDomainField);
        controlPanel.add(minRangeField);
        controlPanel.add(rangeStepPanel); //Panel
    ...
    public static void main(String[] args) {
        JavmosGUI polynomialGUI = new JavmosGUI(); //MAIN HERE
    }
}
